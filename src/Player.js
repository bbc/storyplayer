...
// Smallest possible valid blank sources
// mp3 https://github.com/mathiasbynens/small/blob/master/mp3.mp3?raw=true
// mp4 https://github.com/mathiasbynens/small/blob/master/mp4.mp4?raw=true


const blankAudio = 'data:audio/mpeg;base64,/+MYxAAAAANIAAAAAExBTUUzLjk4LjIAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=='; // eslint-disable-line max-len
const blankVideo = 'data:video/mp4;base64,'; // eslint-disable-line max-len
...
class Player extends EventEmitter {
    ...
    constructor(target: HTMLElement, analytics: AnalyticsLogger) {
        ...
        // Have to load in a source for the elements to be able to be activated on tablet.
        // Here the smallest possible valid blank sources are used (from github)
        this._iOSVideoElement.src = blankVideo;
        this._iOSAudioElement.src = blankAudio;
