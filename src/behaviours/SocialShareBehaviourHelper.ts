...
const createTwitterIcon = (shareText, shareUrl) => {
    ...
    twitterDiv.addEventListener(
        "touchend",
        handleButtonTouchEvent(twitterAction),
    )
...
const createEmailIcon = (shareText, shareUrl) => {
    ...
    const emailAction = () =>
        window.open(`mailto:?Subject=${shareText}&body=${shareUrl}`)
...
const createFacebookIcon = (shareText, shareUrl) => {
    ...
    facebookDiv.addEventListener(
        "touchend",
        handleButtonTouchEvent(facebookAction),
    )
