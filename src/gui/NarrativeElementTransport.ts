...
class NarrativeElementTransport extends EventEmitter {
    ...
    constructor(logUserInteraction: UILogFunction) {
        ...
        this._seekBackButton.setAttribute(
        ...
        this._seekForwardButton.setAttribute(
            "spatial-navigation-object",
            "transport",
        )
        ...
        this._seekBackButton.onclick = this._seekBackwardButtonClicked.bind(
            this,
        )
        ...
        this._seekForwardButton.onclick = this._seekForwardButtonClicked.bind(
            this,
        )
