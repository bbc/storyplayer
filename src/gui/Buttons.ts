...
class Buttons extends BaseButtons {
    ...
    _createSubtitlesButton() {
        ...
        subsButton.setAttribute("spatial-navigation-object", "transport")
    ...
    _createFullscreenButton() {
        ...
        fsButton.setAttribute("spatial-navigation-object", "transport")
        const fullscreenButtonIconDiv = document.createElement("div")
        fullscreenButtonIconDiv.classList.add("romper-button-icon-div")
        fullscreenButtonIconDiv.classList.add(
            "romper-fullscreen-button-icon-div",
        )
    ...
    _initiateTransportControls() {
        const transportControls = new NarrativeElementTransport(
            this._logUserInteraction,
        )
        
        const buttonsOfInterest = [
        ...
        buttonsOfInterest.forEach(eventType => {
    ...
    _handleSubtitlesButton() {
        ...
        const showingSubtitlesIntToString = ["hidden", "showing"]
    ...
    getControlsDiv(volumeOverlay, chapterOverlay, switchableOverlay) {
